<template>
  <div class="min-h-screen flex flex-col bg-white">
    ...
    <!-- Navigation -->
    <header class="bg-white shadow-sm border-b border-gray-100 relative z-10">
      <div class="container mx-auto px-4 py-6 flex justify-between items-center">
        ...
        <nav class="hidden md:flex space-x-8">
          ...
          <router-link to="/services" class="nav-link text-gray-700 hover:text-yellow-600 transition-colors font-medium">Services</router-link>
          <router-link to="/gallery" class="nav-link text-gray-700 hover:text-yellow-600 transition-colors font-medium">Gallery</router-link>
          <router-link to="/appointments" class="nav-link text-gray-700 hover:text-yellow-600 transition-colors font-medium">Appointments</router-link>
        </nav>
    ...
    <!-- Footer -->
    <footer class="bg-gradient-to-b from-white to-yellow-50 border-t border-gray-100 py-12 relative">
      ...
      <div class="container mx-auto px-4 relative z-10">
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div class="text-center">
            <h4 class="font-bold mb-4 text-lg serif gold-accent">Contact Us</h4>
          ...
          <div class="text-center md:text-right">
            ...
            <p class="text-gray-600 mb-2">Monday - Friday: 9am - 7pm</p>
            <p class="text-gray-600 mb-2">Saturday: 10am - 6pm</p>
